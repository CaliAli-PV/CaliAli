...
if ~(numel(varargin)==1 && isempty(varargin{1}))
    ...
    % pairs in 2xN form: row 1 = names, row 2 = values.
...
addParameter(inp,'incremental',false,valid_bool_scalar)      % True when output was generated by incremental alignment
addParameter(inp,'incremental_mask',[])  % Final incremental crop mask in reference aligned coordinates
