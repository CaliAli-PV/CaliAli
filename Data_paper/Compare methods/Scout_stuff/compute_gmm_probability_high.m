function probability=compute_gmm_probability_high(x,w,mu,sigma,min_x,max_x)
...
f= @(x) (w(2)*normpdf(x,mu(2),sigma(2)))./(w(1)*normpdf(x,mu(1),sigma(1))+w(2)*normpdf(x,mu(2),sigma(2)));
