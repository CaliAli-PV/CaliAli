...
neuron.CaliAli_opt=CaliAli_load(in,'CaliAli_options');
neuron.select_data(in);
neuron.getReady();
evalin( 'base', 'clearvars -except parin theFiles' );
%% Load parameters stored in .mat file

neuron.options.Cn=neuron.CaliAli_opt.inter_session_alignment.Cn;
neuron.options.PNR=neuron.CaliAli_opt.inter_session_alignment.PNR;
...
for loop=1:10
    ...
    neuron.merge_high_corr(neuron.show_merge,neuron.CaliAli_opt.cnmf.merge_thr_spatial);
...
% ix=postprocessing_app(neuron,0.9);
