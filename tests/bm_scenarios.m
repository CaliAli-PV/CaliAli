...
% svd and nmf are no longer configurable. They came from CNMF-E, were written
% for two-photon data, and were never implemented for the batched extraction
% CaliAli runs. Setting one now warns and uses ring, which is what this checks.
scn(end+1) = bm_mk('G2','an unsupported background model warns and falls back', ...
    {'downsampling.batch_sz',0}, {'background_model'}, false);
