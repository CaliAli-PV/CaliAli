function params=CaliAli_demo_parameters_dendrites_1p()
% CaliAli_parameters  Defines parameters for CaliAli.

% --- Data Preprocessing ---
params.gSig = [1,7];              % Gaussian filter size for dendrite (pixels)
...
params.detrend = 0.1;             % Detrending window (seconds). 0 = no detrending


% Modified paramentes
params.structure='dendrite';
params.dendrite_size=1.2:0.2:2;
params.fastPNR=true;
params.do_alignment=false;
params.remove_BV=true;
