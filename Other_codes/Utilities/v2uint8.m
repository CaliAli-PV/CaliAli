...
% scales it to uint8 format. It processes the data in batches if the input array
...
availableMemory=availableMemory*0.9; % to no overload the system
...
if requiredMemory <= availableMemory
    ...
    % Memory required per slice (in **GB**, corrected from MB)
