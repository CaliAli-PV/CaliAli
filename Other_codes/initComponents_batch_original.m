function obj=initComponents_batch_original(obj, K, save_avi, use_parallel)
...
obj.CaliAli_opt.dynamic_spatial=0;
...
for mbatch=1:nbatches
    ...
    if mbatch>1
     neuron_k.initComponents_residual_parallel([],neuron_k.frame_range, save_avi, use_parallel);
    end
    % collect results
